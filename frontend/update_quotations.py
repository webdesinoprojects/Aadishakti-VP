...
drawer_path = os.path.join(src_dir, "vendor", "components", "QuotationDrawer.jsx")
drawer_content = """import { X, Calendar, FileText, IndianRupee } from 'lucide-react';
...
# Update QuotationsPage.jsx
qt_page = os.path.join(src_dir, "vendor", "pages", "QuotationsPage.jsx")
with open(qt_page, "r", encoding="utf-8") as f:
    qt_content = f.read()

if "QuotationDrawer" not in qt_content:
    qt_content = qt_content.replace(
    ...
    with open(qt_page, "w", encoding="utf-8") as f:
        f.write(qt_content)

print("Updates completed for My Quotations.")
